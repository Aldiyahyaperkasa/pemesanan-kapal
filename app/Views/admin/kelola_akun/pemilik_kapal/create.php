...
<div class="page-header">
    <div class="breadcrumb-modern">
        Dashboard / Manajemen Akun Pemilik Kapal / Tambah
    </div>
</div>
<div class="col-12">
    <div class="form-wrapper">
        ...
        <div class="premium-card">
            ...
            <div class="premium-header">
                <h4 class="premium-title">Tambah Pemilik Kapal</h4>
                <div class="premium-subtitle">
                    Tambahkan data pemilik kapal baru ke dalam sistem
                </div>
            </div>

            <form method="post"
                  action="<?= site_url('admin/kelola-akun/pemilik-kapal/store'); ?>">
