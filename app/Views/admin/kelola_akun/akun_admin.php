...
<div class="col-12">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold text-primary">Kelola Akun Admin</h3>        
        <a href="<?= base_url('akun_admin/tambah') ?>" class="btn btn-primary rounded-pill">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle text-nowrap">
                    ...
                    <tbody>
                        <?php if (count($admins) > 0): ?>
                            <?php foreach ($admins as $index => $admin): ?>
                                <tr>
                                    ...
                                    <td class="fw-semibold"><?= esc($admin['nama_lengkap']) ?></td>
                                    <td><?= esc($admin['email']) ?></td>
                                    <td><?= esc($admin['username']) ?></td>
                                    <td><?= esc($admin['no_hp']) ?></td>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="text-center text-muted fst-italic py-4">Belum ada data admin.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
