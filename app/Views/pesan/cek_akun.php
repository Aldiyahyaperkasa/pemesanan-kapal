...
<body>
  ...
  <div class="container py-5" style="max-width: 480px; margin-top: 100px;">
    <div class="card shadow-sm p-4 text-center">
      <h3 class="mb-4">Apakah Anda sudah memiliki akun?</h3>
      <a href="<?= base_url('pesan/login/' . $id_kapal) ?>" class="btn btn-primary btn-lg w-100">
        <i class="bi bi-box-arrow-in-right me-2"></i>Sudah Punya Akun, Login
      </a>
      <div class="text-center m-3">atau</div>
      <a href="<?= base_url('pesan/form_registrasi/' . $id_kapal) ?>" class="btn btn-outline-primary btn-lg w-100">
        <i class="bi bi-pencil-square me-2"></i>Belum Punya Akun, Daftar & Pesan
      </a>
    </div>
  </div>
