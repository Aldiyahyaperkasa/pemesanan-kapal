...
<div class="container py-5">
  <div class="card card-custom">
    ...
    <form method="post" action="<?= base_url('pesan/form_pemesanan/' . $kapal['id_kapal']) ?>">
      <?= csrf_field() ?>
      ...
      <div class="mb-3">
        ...
        <input type="text" id="username" name="username" value="<?= esc($user['username']) ?>" class="form-control" readonly>
      </div>
      <div class="mb-3">
        <label for="password" class="form-label">Password</label>
        <input type="password" id="password" name="password" value="********" class="form-control" readonly>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" id="nama_lengkap" name="nama_lengkap" value="<?= esc($user['nama_lengkap']) ?>" class="form-control" readonly>
      </div>
      <div class="mb-3">
        <label for="email" class="form-label">Email</label>
        <input type="email" id="email" name="email" value="<?= esc($user['email']) ?>" class="form-control" readonly>
      </div>
      <div class="mb-3">
        <label for="no_hp" class="form-label">No HP</label>
        <input type="tel" id="no_hp" name="no_hp" value="<?= esc($user['no_hp']) ?>" class="form-control" readonly>
      </div>
